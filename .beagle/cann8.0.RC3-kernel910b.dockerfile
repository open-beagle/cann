...
RUN mkdir -p /tmp/Ascend-cann/ && \
  ...
  #   chmod +x /tmp/Ascend-cann-kernels-910_8.0.RC3.alpha003_linux-aarch64.run && \
  #   /tmp/Ascend-cann-kernels-910_8.0.RC3.alpha003_linux-aarch64.run \
  #   --quiet --install --install-for-all --extract=/tmp/Ascend-cann/kernels-910 && \
  curl -fL -o /tmp/Ascend-cann-kernels-910b_8.0.RC3.alpha003_linux-aarch64.run \
    ...
    /tmp/Ascend-cann-kernels-910b_8.0.RC3.alpha003_linux-aarch64.run \
